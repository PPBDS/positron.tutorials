...
<!-- DK: Split this into three questions, each using the same image, but with a (different) red arrow pointing to the area of interest each time. -->
...
* Quarto is "Watching files for changes" at the Terminal. If you change and then render `analysis.qmd`, Quarto will automatically display the updated HTML in the Viewer.
...
<!-- DK: Add a question in which you ask AI how to get rid of the warnings. It tells you to modify library(tidyverse). Do so and then you can elimate the warning: false from the YAML. -->
...
<!-- DK: This plot is sort of ugly, especially the use of discreet numbers to size the dots. That is just wrong! Make it better, and then adjust the repo-8.png. And others? -->
