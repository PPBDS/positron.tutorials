...
Also, add the following to the YAML header to remove all code echos from the HTML:
...
Place your cursor in the QMD file on the `suppressPackageStartupMessages()` line. Use `Cmd/Ctrl + Shift + Enter` to execute that line. This should load up all the libraries in the Console.
...
Place your cursor at the first line of this code and run `Cmd/Ctrl + Shift + Enter`.
