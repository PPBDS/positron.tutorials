...
<!-- DK: Don't forget about removing the comments which allow check_current_tutorial() to work. -->

<!-- DK: Are there code chunks nestled win quadruple backticks that don't work!??! -->
...
Add these code chunks from the previous section to `quarto-2.qmd`.
