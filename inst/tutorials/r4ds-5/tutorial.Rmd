...
Place your cursor in the QMD file on the `library(tidyverse)` line. Use `Cmd/Ctrl + Enter` to execute that line. This causes `library(tidyverse)` to be copied down to the Console and then executed. Do this for the other libraries as well.
