...
request("[https://web.archive.org/web/20220201012049/https://www.imdb.com/chart/top/](https://web.archive.org/web/20220201012049/https://www.imdb.com/chart/top/)") |> 
  req_perform() |> 
  resp_body_html() |> 
  html_element("table") |>
  html_table() |>
  ...
  mutate(
    rank_title_year = str_replace_all(rank_title_year, "\n +", " "),
    rating_details = request("[https://web.archive.org/web/20220201012049/https://www.imdb.com/chart/top/](https://web.archive.org/web/20220201012049/https://www.imdb.com/chart/top/)") |> 
  req_perform() |> 
  resp_body_html() |> 
      html_elements("td strong") |>
      html_attr("title")
...
```{r, echo = TRUE}
top_movies <- request("[https://web.archive.org/web/20220201012049/https://www.imdb.com/chart/top/](https://web.archive.org/web/20220201012049/https://www.imdb.com/chart/top/)") |> 
  req_perform() |> 
  resp_body_html() |> 
  html_element("table") |>
  html_table() |>
...
```{r top-movies-19-test, echo=TRUE}
top_movies
```
