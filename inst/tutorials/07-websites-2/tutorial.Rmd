...
Place your cursor in `process_data.R` at `filter(z != 0) |>`. Hit `Cmd/Ctrl + Shift + Enter`. This will cause the pipe to be pasted to the Console and then executed there. (Note that this should generate an error.) CP/CR.
