...
Since we have already loaded **tidyverse**, we have therefore loaded **tidyr**, **ggplot2**, and **dplyr**, along with the other packages which are part of the "core" *Tidyverse*. 
