...
Put what it gives you in a new code chunk and do `Cmd/Ctrl + Shift + Enter` to send it to the Console.
...
Take your code chunk and do `Cmd/Ctrl + Shift + Enter` to send it to the Console.
...
Replace your code with this code in your chunk and do `Cmd/Ctrl + Shift + Enter` to send it to the console
...
Put what it gives you in the code chunk and do `Cmd/Ctrl + Shift + Enter` to send it to the console
