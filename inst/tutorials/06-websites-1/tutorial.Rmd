...
If you just the "new window" option, you may need to close the "Welcome" window and start an R interpreter for the Console. If you don't create a new window, you will need to restart the tutorial and create a new Console.
