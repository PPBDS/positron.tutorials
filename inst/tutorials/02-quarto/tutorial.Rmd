...
* `Cmd/Ctrl + Shift + Enter` will run just the code at the line in which the cursor is located.
...
The key lesson is that we are operating in two worlds simultaneously: QMD World and Console World. We are responsible for keeping them in sync with commands like `Cmd/Ctrl + Shift + Enter`.
