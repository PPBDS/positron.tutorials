...
<!-- Delete these next comments once we figure out how best to handle publishing from Positron. -->
...
Because we have not added any code chunk options, we see the code in the HTML file, along with the title. But there is no output because assignment of a value does not result in printed output in R.
