...
Click "New Window" because the Console in your current Positron window is being used to run the tutorial. You always need two windows when completing a tutorial.
