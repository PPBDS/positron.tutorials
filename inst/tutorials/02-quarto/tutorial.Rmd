...
This will render the document, specified with the `input` argument, locally in order to create an HTML which will ne sent to the `server`, which is RPubs.
...
* You can leave the description blank if you don't want to add one.
